...
<div class="bought">
    <div class="tabs">
        <a href="<?php echo u('index');?>" class="tabs-item ">
  									<span class="item-mod">
        ...
        <a href="<?php echo u('nopay');?>" class="tabs-item">
  									<span class="item-mod">
        ...
        <a href="<?php echo u('haspost');?>" class="tabs-item">
  									<span class="item-mod">
        ...
        <a href="<?php echo u('noreceive');?>" class="tabs-item">
  									<span class="item-mod">
  										<span class="item-text">已发货</span><span class="item-count"></span>
  									</span>
            <span class="right-mod"></span>
        </a>
        <a href="<?php echo u('already');?>" class="tabs-item">
  									<span class="item-mod selected">
  										<span class="item-text">已完成</span><span class="item-count"></span>
  									</span>
            <span class="right-mod"></span>
        </a>
    ...
    <?php if(is_array($orderData)): foreach($orderData as $key=>$v): ?><div class="order">
            <div class="order-content">
                <div class="head">
                    <div class="dingdan">
                        <div class="time">
                            <input type="checkbox" name="" id="" value="" /><span name="time" class="order-time"><?php echo (date("Y-m-d H:i",$v['time'])); ?></span><span class="order-num">订单号:<span><?php echo ($v['glnumber']); ?></span></span>
                        </div>
                        <div class="merchant">
  												<span>
                    ...
                    <tr style="height: 108px;">
                        <td class="good-detail " style="width: 38%;">
                            <div class="mod-content">
                                <a href="#"><img src="<?php echo ($v['pic']); ?>" class="pic"/></a>
                                <div style="margin-left: 90px;">
                                    <p>
                                        <a href="#" style="font-size: 12px;"><?php echo ($v['gname']); ?></a>
                                    </p>
                                    <p>
                                        <a href="#"><?php echo ($v['spec']); ?></a>
                                    </p>
                                    <p>
                        ...
                        <td class="gpay-detail" style="width: 12%;">
                            <p><strong style="font-weight: bolder;">￥<?php echo ($v['subtotal']); ?>.00</strong></p>
                            <p>(<?php echo ($v['status']); ?>)</p>
                        </td>
