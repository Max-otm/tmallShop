    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="cid" class="form-control m-b">
                        ...
                        <?php if(is_array($cateData)): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cid']); ?>" tid="<?php echo ($vo['tid']); ?>" <?php if($oldData['cid']==$vo['cid']): ?>selected<?php endif; ?>><?php echo ($vo['_cname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
                        ...
                        <?php if(is_array($typeAttr)): foreach($typeAttr as $key=>$v): ?><tr>
                                ...
                                <td>
                                    <select name="attr[<?php echo ($v['taid']); ?>]" >
                                        ...
                                        <?php if(is_array($v["tavalue"])): foreach($v["tavalue"] as $key=>$vv): ?><option value="<?php echo ($vv); ?>" <?php if(in_array($vv,$checkAttr)): ?>selected<?php endif; ?>><?php echo ($vv); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </td>
                ...
                <div class="col-sm-10">
                    <table class="table table-hover" id="spec">
                        <?php if(is_array($typeSpec)): foreach($typeSpec as $key=>$v): ?><tr>
                                <td><?php echo ($v['taname']); ?></td>
                                <td>
                                    <select name="spec[<?php echo ($v['taid']); ?>][norms][]">
                                        <option value="0">请选择</option>
                                        <?php if(is_array($v["tavalue"])): foreach($v["tavalue"] as $key=>$vv): ?><option value="<?php echo ($vv); ?>" <?php if($vv==$v['gtvalue']): ?>selected<?php endif; ?>><?php echo ($vv); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </td>
                                <td>
                                    附加价格
                        ...
                        <script>
                            $(function(){
                                //把每个规格的第一个按钮设置成追加按钮
                                $('#spec').find("tr:contains(<?php echo ($v['taname']); ?>)").eq(0).find("td:last").html('<button type="button" class="btn btn-success addSpec">追加</button>');
                            })
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="bid" class="form-control m-b">
                        <option value="0">请选择</option>
                        <?php if(is_array($brandData)): $i = 0; $__LIST__ = $brandData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['bid']); ?>" <?php if($oldData['bid']==$vo['bid']): ?>selected<?php endif; ?>><?php echo ($vo['bname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" name="shopprice" class="form-control"  value="<?php echo ($oldData['shopprice']); ?>">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8" id="box">
                    <?php if(is_array($oldData['big'])): foreach($oldData['big'] as $key=>$vo): if($vo!='0'): ?><img style='width:80px' src="<?php echo ($vo); ?>" /><input type='hidden' name='img[]' value='<?php echo ($vo); ?>' /><?php endif; endforeach; endif; ?>
                </div>
                <script>
                    $(function () {
