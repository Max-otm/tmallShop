...
<form class="form-horizontal" id="form" action="" method="post">
    <div class="panel panel-default">
        <div class="panel-body">
            <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="form-group">
                <label class="col-sm-2 control-label"><?php echo ($v['taname']); ?></label>
                <div class="col-sm-3">
                    <select class="form-control" name="combine[]">
                        <?php if(is_array($v['select'])): foreach($v['select'] as $key=>$vv): ?><option value="<?php echo ($vv['gtid']); ?>"><?php echo ($vv['gtvalue']); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="number" value="" placeholder="请输入货号" required>
                </div>
            </div>
        </div>
    </div>
