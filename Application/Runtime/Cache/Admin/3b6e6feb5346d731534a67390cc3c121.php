...
<table class="table table-hover" style="margin: 20px">
    ...
    <?php if(is_array($list)): foreach($list as $k=>$v): ?><tr>
            <th width="80"><?php echo ($v['tid']); ?></th>
            <td><?php echo ($v['tname']); ?></td>
            <td><a class="btn btn-info" href="<?php echo u('admin/type/typeattr',['tid'=>$v['tid']]);?>" >查看属性</a>
                <a class="btn btn-primary" href="<?php echo u('admin/type/save',['tid'=>$v['tid']]);?>" >编辑</a>
                <a class="btn btn-danger" href="javascript:;"onclick="del(<?php echo ($v['tid']); ?>)">删除</a></td>
        </tr><?php endforeach; endif; ?>
    </tbody>
</table>
<a class="btn btn-warning" href="<?php echo u('admin/type/save');?>" style="margin-left: 20px;">添加</a>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href="<?php echo u('admin/type/delete/tid/"+tid+"');?>";
                }
            }
        });
        //显示模态框
