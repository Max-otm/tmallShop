    ...
    <div class="col-sm-12">
        <table class="table table-bordered" style="margin: 20px">
            ...
            <?php if(is_array($list)): foreach($list as $k=>$v): ?><tr>
                    <td style="vertical-align: middle;text-align: center;font-size: 15px;color: orange;"><?php echo ($v[gid]); ?></td>
                    <td style="color: red;"><?php echo ($v['gname']); ?></td>
                    <td><span style="font-size: 12px;font-family: Arial;">市场价：</span><span style="text-decoration: line-through;
font-size: 12px;font-family: Arial;">￥<?php echo ($v['marketprice']); ?></span>
                        <span style="font-size: 14px;font-family:'宋体';color: #FF0036;">销售价:</span><span style="vertical-align: middle;font-size: 15px;color: #FF0036;font-weight:bolder;font-family: Arial;">￥<?php echo ($v['shopprice']); ?></span>
                    </td>
                    <td><?php echo ($v['total']); ?></td>
                    <td><img src="<?php echo ($v['pic']); ?>" alt="" height="45"></td>
                    <td><?php echo (date("Y-m-d H:i",$v['time'])); ?></td>
                    <td>
                        <a class="btn btn-warning btn-sm" href="<?php echo u('admin/GoodsList/index',['gid'=>$v['gid']]);?>" style="margin-left: 20px;">查看货余量</a>
                        <a class="btn btn-primary btn-sm" href="<?php echo u('admin/goods/edit',['gid'=>$v['gid']]);?>" >编辑</a>
                        <a class="btn btn-danger btn-sm" href="javascript:;"onclick="del(<?php echo ($v['gid']); ?>)">删除</a>
                    </td>
        ...
        <div class="btn-group">
            <a href="<?php echo u('admin/Goods/add');?>" class="btn btn-warning">商品添加</a>
        </div>
    </div>
</div>
<script>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href="<?php echo u('admin/goods/delete/gid/"+gid+"');?>";
                }
            }
        });
        //显示模态框
