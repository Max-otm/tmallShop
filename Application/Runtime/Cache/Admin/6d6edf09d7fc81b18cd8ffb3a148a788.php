...
<table class="table table-hover" style="margin: 20px">
    ...
    <tbody>
    <?php if(is_array($addressData)): foreach($addressData as $k=>$v): ?><tr>
            <th width="80"><?php echo ($v['adid']); ?></th>
            <td><?php echo ($v['consignee']); ?></td>
            <td><?php echo ($v['iscur']); ?></td>
            <td><?php echo ($v['phone']); ?></td>
            <td><?php echo ($v['area']); ?></td>
            <td><?php echo ($v['address']); ?></td>
            <td>
                <a class="btn btn-primary" href="<?php echo u('admin/user/edit',['adid'=>$v['adid'],'uid'=>I('get.uid')]);?>" >修改</a>
                <a class="btn btn-danger" href="javascript:;"onclick="del(<?php echo ($v['adid']); ?>)">删除</a></td>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href="<?php echo u('admin/user/delete',['adid'=>$v['adid'],'uid'=>I('get.uid')]);?>";
                }
            }
        });
        //显示模态框
