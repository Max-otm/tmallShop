...
<table class="table table-hover" style="margin: 20px">
    ...
    <tbody>
    <?php if(is_array($userData)): foreach($userData as $k=>$v): ?><tr>
            <th width="80"><?php echo ($v['uid']); ?></th>
            <td><?php echo ($v['username']); ?></td>
            <td><?php echo ($v['phone']); ?></td>
            <td><?php echo ($v['money']); ?></td>
            <td>
                <a class="btn btn-primary" href="<?php echo u('admin/user/addr',['uid'=>$v['uid']]);?>" >管理用户地址</a>
                <a class="btn btn-danger" href="javascript:;"onclick="del(<?php echo ($v['uid']); ?>)">删除</a></td>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href="<?php echo u('admin/user/delete/uid/"+uid+"');?>";
                }
            }
        });
        //显示模态框
