...
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="#tab1"><?php echo ($tname); ?></a></li>
</ul>
<table class="table table-hover" style="margin: 20px">
    <thead>
    <tr>
        <th width="80">类型属性id</th>
        <th>属性名</th>
        <th width="500">属性值</th>
        <th>属性类型</th>
        <th>操作</th>
    ...
    <?php if(is_array($list)): foreach($list as $k=>$v): ?><tr>
            <th width="80"><?php echo ($v['taid']); ?></th>
            <td><?php echo ($v['taname']); ?></td>
            <td width="500"><?php echo ($v['tavalue']); ?></td>
            <td>

                <?php if($v['class']==1): ?>规格
                    <?php else: ?>属性<?php endif; ?>
            </td>
            <td>
                <a class="btn btn-primary" href="<?php echo u('admin/type/attrsave',['taid'=>$v['taid'],'tid'=>I('get.tid')]);?>" >编辑</a>
                <a class="btn btn-danger" href="javascript:;"onclick="del(<?php echo ($v['taid']); ?>,<?php echo ($v['tid']); ?>)">删除</a>
            </td>

        </tr><?php endforeach; endif; ?>
    </tbody>
</table>
<a class="btn btn-warning" href="<?php echo u('admin/type/attrsave',['tid'=>I('get.tid')]);?>" style="margin-left: 20px;">添加</a>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href="<?php echo u('admin/type/attrdelete/taid/"+taid+"/tid/"+tid+"');?>";
                }
            }
        });
        //显示模态框
