...
<form action="" method="post">
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <?php if(is_array($data)): foreach($data as $k=>$v): ?><tr>
                        ...
                        <td><input type="text" class="form-control" name="<?php echo ($v['name']); ?>" value="<?php echo ($v['value']); ?>"></td>
    ...
    <button class="btn btn-primary" type="submit"style="margin-left: 100px">确定</button>
</form>
