...
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="#tab1">品牌列表</a></li>
</ul>
<table class="table table-hover" style="margin: 20px">
    ...
    <?php if(is_array($data)): foreach($data as $k=>$v): ?><tr>
            <th width="80"><?php echo ($v['bid']); ?></th>
            <td><?php echo ($v['bname']); ?></td>
            <td><img src="<?php echo ($v['brandlogo']); ?>" alt="" width="50" height="20"></td>
            <td>
                <a class="btn btn-primary" href="<?php echo u('admin/brand/save',['bid'=>$v['bid']]);?>" >编辑</a>
                <a class="btn btn-danger" href="javascript:;"onclick="del(<?php echo ($v['bid']); ?>)">删除</a></td>
        </tr><?php endforeach; endif; ?>
    </tbody>
</table>
<a class="btn btn-warning" href="<?php echo u('admin/brand/save');?>" style="margin-left: 20px;">添加</a>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href="<?php echo u('admin/brand/delete/bid/"+bid+"');?>";
                }
            }
        });
        //显示模态框
