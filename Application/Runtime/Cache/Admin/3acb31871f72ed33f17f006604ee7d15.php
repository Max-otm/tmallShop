        ...
        <section class="panel panel-default">
            <div class="panel-body">
                <table class="table table-bordered">
                   <thead>
                   <tr>
                       <th class="col-sm-2">货品id</th>
                       <th class="col-sm-3">商品规格</th>
                       <th class="col-sm-3">货号</th>
                       <th class="col-sm-2">货余量</th>
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                        ...
                        <td style="color: red;"><?php echo ($v['combine']); ?></td>
                        <td style="color: black;"><?php echo ($v['number']); ?></td>
                        <td><?php echo ($v['inventory']); ?></td>
                        <td>
                            <a class="btn btn-primary btn-sm" href="<?php echo u('admin/GoodsList/save',['glid'=>$v['glid'],'gid'=>I('get.gid')]);?>" >编辑</a>
                            <a class="btn btn-danger btn-sm" href="<?php echo u('admin/GoodsList/delete',['glid'=>$v['glid'],'gid'=>I('get.gid')]);?>">删除</a>
                        </td>
...
<div class="btn-group">
    <a href="<?php echo u('admin/Goods/index');?>" class="btn btn-primary"> <<回到商品列表</a><a href="<?php echo u('admin/GoodsList/save',['gid'=>I('get.gid')]);?>" class="btn btn-warning">商品添加</a>
</div>
