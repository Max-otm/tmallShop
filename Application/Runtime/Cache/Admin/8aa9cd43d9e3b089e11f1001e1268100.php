...
<ul class="nav nav-tabs" role="tablist">
    <?php if(I('get.taid')): ?><li class="active"><a href="#tab1">属性编辑</a></li>
        <?php else: ?> <li class="active"><a href="#tab1">属性添加</a></li><?php endif; ?>
</ul>
<form action="" method="post" class="form-inline">
    <div class="form-group" style="margin: 50px">
        <label for="Taname">属性名:</label>
        <input type="text" name="taname" id="Taname" value="<?php echo ($oldData['taname']); ?>" class="form-control" style="width: 300px;">
        <br><br>
        <?php if(isset($oldData['class'])): if($oldData['class']==1): ?><input type="radio" name="class" value="1" checked>规格
                <input type="radio" name="class" value="2" >属性
                <?php else: ?>
                <input type="radio" name="class" value="1">规格
                <input type="radio" name="class" value="2" checked>属性<?php endif; ?>
        <?php else: ?>
           <input type="radio" name="class" value="1" checked>规格<input type="radio" name="class" value="2">属性</label><?php endif; ?>
        <br>
        <label for="Tavalue">请输入值(可以为多个):</label>
        <input type="text" name="tavalue" id="Tavalue" value="<?php echo ($oldData['tavalue']); ?>" class="form-control" style="width: 300px;" placeholder="每个值之间请用逗号隔开">
        <br><br>
