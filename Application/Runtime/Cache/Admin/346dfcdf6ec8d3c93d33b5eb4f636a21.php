    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="gnumber" class="form-control" value="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="cid" class="form-control m-b">
                        ...
                        <?php if(is_array($cateData)): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cid']); ?>" tid="<?php echo ($vo['tid']); ?>"><?php echo ($vo['_cname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="bid" class="form-control m-b">
                        ...
                        <?php if(is_array($brandData)): $i = 0; $__LIST__ = $brandData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['bid']); ?>"><?php echo ($vo['bname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                     <input type="number" name="marketprice" class="form-control"  value="">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" name="shopprice" class="form-control"  value="">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text"  class="form-control" name="click" placeholder="" value="">
                </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="input-group" style="margin-top:5px;">
                            <img src="/tpShop/tpShop/Shop/node_modules/hdjs/images/nopic.jpg" class="img-responsive img-thumbnail" width="150">
