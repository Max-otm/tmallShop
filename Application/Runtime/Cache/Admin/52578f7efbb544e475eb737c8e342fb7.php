    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="bname" value="<?php echo ($oldData['bname']); ?>" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">品牌排序</label>
                <div class="col-sm-9">
                    <input type="text" name="bsort" value="<?php echo ($oldData['bsort']); ?>" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">品牌热门</label>
                <?php if($oldData): if($oldData['ishot']==1): ?><input type="radio" name="ishot" checked value="1">是
                        <input type="radio" name="ishot"  value="2">否
                        <?php else: ?>  <input type="radio" name="ishot"  value="1">是
                        <input type="radio" name="ishot" checked value="2">否<?php endif; ?>
                    <?php else: ?>
                    <div class="col-sm-9">
                ...
                <div class="col-sm-9">
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="text" class="form-control" name="brandlogo" readonly="" value="<?php echo ($oldData['brandlogo']); ?>">
                            <div class="input-group-btn">
                                <button onclick="upImage(this)" class="btn btn-default" type="button">选择图片</button>
                            </div>
                        </div>
                        <div class="input-group" style="margin-top:5px;">
                            <?php if($oldData['brandlogo']==null): ?><img src="/tpShop/tpShop/Shop/Public/Admin/images/nopic.jpg" class="img-responsive img-thumbnail" width="150">
                                <?php else: ?>
                                <img src="<?php echo ($oldData['brandlogo']); ?>" class="img-responsive img-thumbnail"
                                     width="150"><?php endif; ?>
