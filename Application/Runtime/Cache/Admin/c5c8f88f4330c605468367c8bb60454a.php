...
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="#tab1">地址修改</a></li>
</ul>
<script  src="/tpShop/tpShop/Shop/Public/Home/js/area.js"></script>
<script type="text/javascript">
    $(function () {
        //初始化方法
        area.init('area');
        //修改的时候默认被选中效果.
        area.selected("<?php echo ($oldData['area'][0]); ?>", "<?php echo ($oldData['area'][1]); ?>", "<?php echo ($oldData['area'][2]); ?>");
    })
</script>
<form action="" method="post">
    ...
    收件人:
    <input type="text" name="consignee"  value="<?php echo ($oldData['consignee']); ?>">
    手机号： <input type="text" name="phone" value="<?php echo ($oldData['phone']); ?>">
    详细地址：
    <textarea  rows="3" name="address"><?php echo ($oldData['address']); ?></textarea>
    <br>
