...
<ul class="nav nav-tabs" role="tablist">
    <li class="active">
        <a href="#tab3">商品货量添加</a>
    </li>
</ul>
<form class="form-horizontal" id="form" action="" method="post">
    <div class="panel panel-default">
        <div class="panel-body">
            <?php if(is_array($data)): foreach($data as $k=>$v): ?><div class="form-group">
                <label class="col-sm-2 control-label"><?php echo ($v['taname']); ?></label>
                <div class="col-sm-3">
                    <select class="form-control" name="combine[]">
                        <?php if(is_array($v['select'])): foreach($v['select'] as $kk=>$vv): ?><option value="<?php echo ($vv['gtid']); ?>"<?php if($vv['gtid']==$oldData['combine'][$k]): ?>selected<?php endif; ?>><?php echo ($vv['gtvalue']); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number" name="inventory" value="<?php echo ($oldData['inventory']); ?>" required value="0" min="0">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">货号</label>
                <div class="col-sm-9">
                    <input type="text" name="number" value="<?php echo ($oldData['number']); ?>" placeholder="请输入货号" required>
                </div>
            </div>
        </div>
    </div>
