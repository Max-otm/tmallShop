...
<ul class="nav nav-tabs" role="tablist">
    <?php if(I('get.tid')): ?><li class="active"><a href="#tab1">类型编辑</a></li>
        <?php else: ?> <li class="active"><a href="#tab1">类型添加</a></li><?php endif; ?>
</ul>
<form action="" method="post" class="form-inline">
    <div class="form-group" style="margin: 50px">
        <label for="Tname">类型:</label>
        <input type="text" name="tname" id="Tname" value="<?php echo ($oldData['tname']); ?>" class="form-control" style="width: 300px;">
        <br>
        <br>
