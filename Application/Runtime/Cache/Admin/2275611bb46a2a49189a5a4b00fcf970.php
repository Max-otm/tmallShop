...
<head>
    ...
    <link href="/tpShop/tpShop/Shop/Public/Admin/css/bootstrap.css" rel="stylesheet">
        ...
        <section class="panel panel-default bg-white m-t-lg">
            ...
            <form method="post" action="" class="panel-body wrapper-lg">
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control input-lg" name="aname">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo u('admin/admin/code');?>" onclick="this.src=this.src+'?co='+Math.random()">
                </div>
...
<script src="/tpShop/tpShop/Shop/Public/Admin/js/jquery.min.js"></script>
<!-- Bootstrap -->
<script src="/tpShop/tpShop/Shop/Public/Admin/js/bootstrap.js"></script>
<!-- App -->
<script src="/tpShop/tpShop/Shop/Public/Admin/js/app.js"></script>
<script src="/tpShop/tpShop/Shop/Public/Admin/js/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/tpShop/tpShop/Shop/Public/Admin/js/app.plugin.js"></script>
</body>
</html>